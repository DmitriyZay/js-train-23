// Шаблонний метод (Template Method) — це патерн програмування, який визначає загальну 
//структуру алгоритму, залишаючи певні кроки реалізації підкласам.
...
class TeaMaker {
  ...
  //по черзі boilWater, addTeaLeaves, #steepTea, pourIntoCup, addCondiments, serveTea.
  makeTea() {
    this.boilWater();
    this.addTeaLeaves();
    this.#steepTea();
  ...
  // Робимо метод addTeaLeaves, який відповідає за додавання чайних листків 
  //та виводить в консоль Додаємо чайні листки....
  addTeaLeaves(){
...
console.log (`Заварюємо чай....`);
  ...
  // Робимо метод pourIntoCup, що відповідає за переливання чаю в чашку та виводить 
  //в консоль Переливаємо чай в чашку....
  pourIntoCup(){
