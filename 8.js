// Медіатор (Mediator) — це патерн програмування, який визначає об'єкт, який інкапсулює 
//взаємодію між групою об'єктів. Медіатор сприяє слабкій залежності між цими об'єктами,
...
return this.messenger.sendMessage( `${this.name} відправив повідомлення ${message}`);
  }
...
class SMSMessenger {
  // Створюємо статичний метод sendMessage який приймає один параметр - message,
  // та виводить в консоль `Відправлено SMS: ${message}`
...
class EmailMessenger {
  // Створюємо статичний метод sendMessage який приймає один параметр - message, 
  //та виводить в консоль `Відправлено Email: ${message}`
static sendMessage(message){
